...
<body>
	...
	<div class="chat-container">
		...
		<main class="chat-main">
			<!-- チャットメッセージ表示エリア -->
			<div id="messages" class="messages-container" role="log"
				aria-live="polite"></div>

			<!-- 入力フォーム -->
			<div class="input-form">
				<input type="hidden" name="id" id="userId" value="<%=escapedId%>"
					data-room-id="<%=escapedId%>">
				<div class="message-input-container">
					<input type="text" id="messageInput" class="message-input"
						placeholder="メッセージを入力" aria-label="メッセージを入力" maxlength="1000">
					<button type="button" onclick="sendMessage()" class="send-button"
						aria-label="メッセージを送信">送信</button>
				</div>
